...
public class DaftarCandiActivity extends ListActivity {
	...
	private static String url_semua_candi = "http://192.168.43.251/candi/semua_candi.php";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_daftar_candi);
	...
	class AmbilDataJson extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(DaftarCandiActivity.this);
		...
		protected String doInBackground(String... args) {
			...
			JSONObject json = jParser.makeHttpRequest(url_semua_candi, "GET",
					params);
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					ListAdapter adapter = new SimpleAdapter(
							DaftarCandiActivity.this, memberList,
							R.layout.list_item, new String[] { TAG_IDMEM,
									TAG_NAMA,TAG_ALAMAT }, new int[] { R.id.idmem,
