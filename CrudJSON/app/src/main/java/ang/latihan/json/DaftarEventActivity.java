...
public class DaftarEventActivity extends ListActivity {
    ...
    private static String url_semua_event = "http://192.168.43.251/candi/semua_event.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String idmem = ((TextView) view.findViewById(R.id.idmem))
                        .getText().toString();
    ...
    class AmbilDataJson extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(DaftarEventActivity.this);
            pDialog.setMessage("Mengambil Data Event. Silahkan Tunggu...");
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jParser.makeHttpRequest(url_semua_event, "GET",
                    params);
            ...
            try {
                ...
                if (sukses == 1) {
                    ...
                    for (int i = 0; i < member.length(); i++) {
                        ...
                        String nama_event = c.getString(TAG_NAMA_EVENT);
                        String tempat = c.getString(TAG_TEMPAT);
                        ...
                        map.put(TAG_NAMA_EVENT, nama_event);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            DaftarEventActivity.this, memberList,
                            R.layout.list_item_event, new String[] { TAG_IDMEM,
                            TAG_NAMA_EVENT,TAG_TEMPAT }, new int[] { R.id.idmem,
                            R.id.nama_event, R.id.tempat });
                    // update listview
